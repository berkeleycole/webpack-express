...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return handleSubmit; });\nconsole.log(\"I exist still\");\nfunction handleSubmit(event) {\n  event.preventDefault();\n  console.log(\"clicked!\");\n  fetch('http://localhost:3000/api').then(function (res) {\n    return res.json();\n  }).then(function (res) {\n    document.getElementById('results').innerHTML = res.remaining;\n  });\n}\n\n//# sourceURL=webpack:///./src/client/js/interaction.js?");
